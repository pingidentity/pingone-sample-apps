...
React UI + Node/Express backend implementing PingOne registration + email-MFA login.
...
- `server/` — Node/Express backend (port 3000). Serves the React build and exposes `/api/*`.
