# p1-user-registration-js

Node.js/Express port of the PingOne self-service user-registration + login demo.
...
Open http://localhost:3000. Requires Node 18+ (uses global `fetch` and `getSetCookie`).
